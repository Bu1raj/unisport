...
import 'package:sports_complex_ms/student_side_app/arena_booking/widgets/sport_grid_item.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: _isLoading ? const CircularProgressIndicator() : GridView(
        ...
        children: [
          for (final sport in sportsList) SportGridItem(sport: sport, parentContext: context,),
        ],
      ),
    );
  }
